...
[![Coverage](https://img.shields.io/badge/coverage-81%25-yellow)](./coverage-policy)
...
- Coverage gate currently enforces >=81%. We'll continue to ratchet this upward as core adaptive components gain additional tests.
