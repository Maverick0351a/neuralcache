...
[![Coverage](https://img.shields.io/badge/coverage-77%25-yellow)](./coverage-policy)
...
- Coverage gate currently enforces >=77%. We'll continue to ratchet this upward as core adaptive components gain additional tests.
